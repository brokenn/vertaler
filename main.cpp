...
public:
  ...
  bool is_at_end() const { return m_current >= m_code.size(); }

  char advance() { return m_code[m_current++]; }
  ...
  Token scan_token() {
    ...
    switch (c) {
    case '(':
      return add_token(TokenType::TOK_LEFT_PAREN);
    case ')':
      return add_token(TokenType::TOK_RIGHT_PAREN);
    case '{':
      return add_token(TokenType::TOK_LEFT_BRACE);
    case '}':
      return add_token(TokenType::TOK_RIGHT_BRACE);
    case ',':
      return add_token(TokenType::TOK_COMMA);
    case '.':
      return add_token(TokenType::TOK_DOT);
    case '-':
      return add_token(TokenType::TOK_MINUS);
    case '+':
      return add_token(TokenType::TOK_PLUS);
    case ';':
      return add_token(TokenType::TOK_SEMICOLON);
    case '*':
      return add_token(TokenType::TOK_STAR);
    }
